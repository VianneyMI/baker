...
file_paths = glob.glob(str(Path(__file__).parents[1] / "data" / "output" / "2_update_the_extraction_results" / "main_run") + "/*.json")
...
output_path = Path(__file__).parents[1] / "data" / "output" / "3_standardize_the_data" / "parsed_recipes.json"
